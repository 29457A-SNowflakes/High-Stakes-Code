...
void Robot::Inits::TuningLogicLoop() {
    rd::Console* AutonTuning = &Robot::Screen::Tuning;
    rd::Selector* TuningSelector = &Robot::Screen::TuningSelector;
    lemlib::Chassis* chassis = &Robot::chassis;
    lemlib::ControllerSettings* angularController = &Robot::angSettings;
    lemlib::ControllerSettings* latController = &Robot::latSettings;
    ...
    Robot::Screen::autonSelector.focus();
}